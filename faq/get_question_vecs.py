...
class ReadVec2bin(object):
    def __init__(self):
        ...
        bert_vecs_path = os.path.join(dir_name, "./bert_vect/bert_vecs.bin")
        bert_sentences_path = os.path.join(dir_name, "./bert_vect/bert_sentences.txt")
        ...
        self.bert_vecs = bert_vecs[1:]
        # self.owner_name_bert_vecs[sheet_name] = bert_vecs[1:]

    def read_bert_sents(self):
        return self.sentences

    def read_bert_vecs(self):
        return self.bert_vecs
