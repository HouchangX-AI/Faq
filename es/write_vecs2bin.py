...
class WriteVec2bin(object):
    ...
    def write_bert_vecs(self):
        ...
        # )
        bert_vecs_path = os.path.join(dir_name, "../faq/bert_vect/bert_vecs.bin")
        bert_sentences_path = os.path.join(
            dir_name, "../faq/bert_vect/bert_sentences.txt"
        )
    ...
    #     """
    #     for i, owner_name in enumerate(self.owner_names):
    #         self.write_bert_vecs(owner_name=owner_name)


if __name__ == "__main__":
    write_vec2bin = WriteVec2bin()
    write_vec2bin.write_bert_vecs()
